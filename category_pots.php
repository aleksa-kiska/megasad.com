...
<body>
  ...
  <!-- Подкатегории Горшков -->
  <div class="subcategory" onclick="toggleProducts('plastikovye')">
  <p style="text-align: center; width: 100%;"><strong>Пластиковые</strong></p>
  </div>
  <div id="plastikovye" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 21): ?>
          <div class="product">
  ...
  <div class="subcategory" onclick="toggleProducts('keramicheskie')">
  <p style="text-align: center; width: 100%;"><strong>Керамические</strong></p>
  </div>
  <div id="keramicheskie" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 22): ?>
          <div class="product">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
            <p><strong><?php echo htmlspecialchars($product['name']); ?></strong></p>
            <p>Артикул: <?php echo htmlspecialchars($product['article']); ?></p>
  ...
  <div class="subcategory" onclick="toggleProducts('ulichnye')">
  <p style="text-align: center; width: 100%;"><strong>Уличные</strong></p>
  </div>
  <div id="ulichnye" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 23): ?>
          <div class="product">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
            <p><strong><?php echo htmlspecialchars($product['name']); ?></strong></p>
            <p>Артикул: <?php echo htmlspecialchars($product['article']); ?></p>
  ...
  <div class="subcategory" onclick="toggleProducts('dlya_rassady')">
  <p style="text-align: center; width: 100%;"><strong>Для рассады</strong></p>
  </div>
  <div id="dlya_rassady" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 24): ?>
          <div class="product">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
            <p><strong><?php echo htmlspecialchars($product['name']); ?></strong></p>
            <p>Артикул: <?php echo htmlspecialchars($product['article']); ?></p>
