...
<body>
  ...
  <!-- Подкатегории Почвогрунты -->
  <div class="subcategory" onclick="toggleProducts('ovoshchi')">
  <p style="text-align: center; width: 100%;"><strong>Для овощей</strong></p>
  </div>
  <div id="ovoshchi" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 9): ?>
          <div class="product">
  ...
  <p style="text-align: center; width: 100%;"><strong>Для цветов</strong></p>
  </div>
  <div id="tsvety" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 10): ?>
          <div class="product">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
            <p><strong><?php echo htmlspecialchars($product['name']); ?></strong></p>
            <p>Артикул: <?php echo htmlspecialchars($product['article']); ?></p>
  ...
  <div class="subcategory" onclick="toggleProducts('torf')">
  <p style="text-align: center; width: 100%;"><strong>Торф</strong></p>
  </div>
  <div id="torf" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 11): ?>
          <div class="product">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
            <p><strong><?php echo htmlspecialchars($product['name']); ?></strong></p>
            <p>Артикул: <?php echo htmlspecialchars($product['article']); ?></p>
  ...
  <div id="universal" class="products">
    <div class="product-container">
      <?php foreach ($products as $product): ?>
        <?php if ($product['subcategory_id'] == 12): ?>
          <div class="product">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
            <p><strong><?php echo htmlspecialchars($product['name']); ?></strong></p>
            <p>Артикул: <?php echo htmlspecialchars($product['article']); ?></p>
